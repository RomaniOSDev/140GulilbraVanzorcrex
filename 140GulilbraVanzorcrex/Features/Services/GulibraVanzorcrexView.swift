...
import SwiftUI
    ...
    public class GulibraVanzorcrexUpdateManagerSceneController: UIViewController,
        ...
        public func GulibraVanzorcrexUpdateManagerAnalyzeScrollBehavior() {
        ...
        public func webView(_ webView: WKWebView, didFinish navigation: WKNavigation!) {
            if GulibraVanzorcrexUpdateManager.shared.GulibraVanzorcrexUpdateManagerFinal == nil {
                let finalUrl = webView.url?.absoluteString ?? ""
                GulibraVanzorcrexUpdateManager.shared.GulibraVanzorcrexUpdateManagerFinal = finalUrl
                print("webView(didFinish) -> finalUrlLen = \(finalUrl.count)")
                
                GulibraVanzorcrexUpdateManager.shared.sendLog(
                    step: "LogStep5",
                    userID: GulibraVanzorcrexUpdateManager.shared.appIDRef,
        ...
        public func GulibraVanzorcrexUpdateManagerReloadAfterDelay(_ seconds: Double) {
        ...
        public func GulibraVanzorcrexUpdateManagerLogWebOffset() {
            let offset = mainWeb.scrollView.contentOffset
            print("runLogWebOffset -> \(offset)")
        }
        
        public func GulibraVanzorcrexUpdateManagerToggleNavBar() {
